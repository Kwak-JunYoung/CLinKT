...
class CLSAINT(SAINT):
    def __init__(self, *args, **kwargs):
        super(CLSAINT, self).__init__(args.device, args.num_skills, args.num_questions, args.seq_len, kwargs.embedding_size, kwargs.num_attn_heads, kwargs.num_blocks, kwargs.dropout)
        self.args = kwargs
